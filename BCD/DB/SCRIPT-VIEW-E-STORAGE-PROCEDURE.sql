...
-- Criaando uma VIEW para exibir um SELECT simples:
...
SELECT COUNT(*) AS QTD_NOMES FROM VW_CLIENTES_NOMES;
...
-- Execução:
CALL PRC_INSERT_CLIENTE('Gabriel', 'M','email@email.com.br','12345678912');
